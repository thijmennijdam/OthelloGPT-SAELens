...
# print the validity of each possible move for game 1, move 1
# print(focus_valid_moves[0, 0, :])
# for element that is 1, print the index
# print("valid moves for game 1, move 1")
# print(t.where(focus_valid_moves[0, 0, :] == 1))
# print("valid moves for game 1, move 2")
# print(t.where(focus_valid_moves[0, 1, :] == 1))
# print("valid moves for game 1, move 3")
# print(t.where(focus_valid_moves[0, 2, :] == 1))
# print("valid moves for game 1, move 4")
# print(t.where(focus_valid_moves[0, 3, :] == 1))
# print("valid moves for game 1, move 5")
# print(t.where(focus_valid_moves[0, 4, :] == 1))
